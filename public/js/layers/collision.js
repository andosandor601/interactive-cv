...
function createEntityLaer(entities) {
    return function drawBoundingBoxes(context) {
...
createTileCandidateLayer(tileCollider) {
    const resolvedTiles = [];
...
export function createCollisionLayer(level) {
    ...
    const drawBoundingBoxes = createEntityLaer(level.entities);
